 ...
 *   @chainable
 */
declare function arc(x: number, y: number, w: number, h: number, start: number, stop: number, mode?: ARC_MODE, detail?: number): p5;
 ...
 *   @chainable
 */
declare function pixelDensity(val: number): p5;
 ...
 *   @chainable
 */
declare function vertex(x: number, y: number, z: number, u?: number, v?: number): p5;
 ...
 */
declare function keyIsDown(key: string|number): boolean;
 ...
 *   found
 */
declare function selectAll(name: string, container?: string): p5.Element[];
 ...
 */
declare function createImg(src: string, successCallback: Function): object|p5.Element;
 ...
 */
declare function createVideo(src: string|string[], callback?: Function): p5.MediaElement;
 ...
 */
declare function createAudio(src?: string|string[], callback?: Function): p5.MediaElement;
